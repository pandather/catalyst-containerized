...
cd ..
export CATALYST_CONTAINER_CACHE_DIR=~/catalyst-container-tmp CATALYST_CACHE_DIR=~/catalyst-tmp BUILDSH_SCRIPT_DIR=./scripts SEED=./example/stage3-amd64-openrc-latest.tar.xz SPEC=./example/stage1.spec
./runCatalyst.sh
